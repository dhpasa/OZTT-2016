...
<head>
  ...
  <script>	
		$(function(){
			...
			// 监听用户选择发件人和收件人
			$("#sendperson_div_id,#sendperson_address_div_id").click(function(){
			...
			$('.powder_back').click(function(){
				...
				if ($(".mpas_address_select_div").css('display') == 'block') {
					...
					$(".mpas_address_select_div").toggle("1500");
					$("#mpas_package_detail_id").show();
				}
				
				if ($(".mpas_package_count").css('display') == 'block') {
					$('.powder_back').css('display','none');
					$(".mpas_package_count").toggle("1500");
					$("#mpas_package_detail_id").show();
				}
	...
	<div class="mpas_package_detail" style="display:none" id="mpas_package_detail_id">
		...
		<div class="mpas_powder_div">
			...
			<div class="mpas_powder_input_info clearfix">
				...
				<div class="mpas_powder_address_div" id="sendperson_address_div_id">
					<i class="glyphicon glyphicon-home"></i>
					<span id="sendperson_address"><fmt:message key="MPAS_PACKAGE_DETAIL_ADDRESS" /></span>
				</div>
...
<script>
	...
	<div class="mpas_address_select_div" style="display:none">
	...
	<div class="mpas_address_input_div" style="display:none">
		<div class="address_input_name">
			<i class="glyphicon glyphicon-list-alt"></i><input ></input>
		</div>
		<div class="address_input_phone">
			<i class="glyphicon glyphicon-earphone"></i><input ></input>
		</div>
