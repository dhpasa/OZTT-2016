...
public final class CommonEnum {
     ...
     * 订单详细状态
     */
    public enum DetailStatus implements IEnum {
        /** 未付款 */
        DE_NOT_PAY("未付款", "0"),
        /** 下单成功 */
        DE_PLACE_ORDER_SU("下单成功", "1"),
        /** 商品派送中 */
        DE_SENDING("商品派送中", "2"),
        /** 完成 */
        DE_COMPLATE("完成", "3"),
         ...
         * @param code String
         */
        private DetailStatus(String label, String code)
        {
            this.label = label;
            this.code = code;
        }
     ...
     * 订单详细处理标志
     */
    public enum OrderDetailStatus implements IEnum {
        /** 商品派送中 */
    	SENDING("商品派送中", "1"),
        /** 完成 */
    	COMPLATE("完成", "2"),
        /** 部分完成 */
        PARTLYCOMPLATE("部分完成", "3"),
        /** 取消 */
        CANCEL("取消", "4");
         ...
         * @param code String
         */
        private OrderDetailStatus(String label, String code)
        {
            this.label = label;
            this.code = code;
        }
         ...
         */
        public static String getEnumLabel(String code) {
            for (OrderDetailStatus c : OrderDetailStatus.values()) {
                if (c.getCode().equals(code)) {
                    return c.label;
                }
            }
